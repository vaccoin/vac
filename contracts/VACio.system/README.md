...
## VACCOIN.system::cfgproducer    account config
...
## VACCOIN.system::okproducer     account producer vote
...
## VACCOIN.system::setproxy       account proxy
...
## VACCOIN.system::unstake        account quantity 
...
## VACCOIN.system::withdraw account
   - this action can only be triggered by VACCOIN.system via a deferred transaction generated by unstake
   - this will generate an inline VACCOIN.token::transfer call from=VACCOIN.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## VACCOIN.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## VACCOIN.system::stakevote account amount
   - the primary currency of VACCOIN is controlled by the token contract which enables users to transfer
...
## VACCOIN.system::onblock   account blocktime blocknum
...
## VACCOIN.system::freeze producer accounts true|false 
...
## VACCOIN.system::paystandby producer
