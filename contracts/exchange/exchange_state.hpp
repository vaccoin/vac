...
namespace VACio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         VACio_assert( interest_shares >= 0, "underflow" );
         VACio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      VACLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         VACLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      VACLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef VACio::multi_index<N(markets), exchange_state> markets;
