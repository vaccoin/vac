 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every VACCOIN contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for VACCOIN contract.
 * @details %Base class for VACCOIN contract. %A new contract should derive from this class, so it can make use of VACCOIN_ABI macro.
 */
class contract {
   public:
      /**
