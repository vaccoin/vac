   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { VACCOIN_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { VACCOIN_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            VACCOIN_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return VACCOIN::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline VACCOIN::datastream<Stream>& operator>> (VACCOIN::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline VACCOIN::datastream<Stream>& operator<< (VACCOIN::datastream<Stream>& ds, const optional& op)
         {
