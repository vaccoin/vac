 ...
 *  VACCOIN::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  VACCOIN::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  VACCOIN::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  VACCOIN::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  VAC_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  VACCOIN::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
