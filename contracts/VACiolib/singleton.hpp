...
namespace  VACCOIN {
    ...
    *  @brief Defines VACCOIN Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         VACLIB_SERIALIZE( row, (value) )
      };

      typedef VACCOIN::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            VACCOIN_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
