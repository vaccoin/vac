 ...
 * @details VACCOIN Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief VACCOIN Signature
 * @details VACCOIN Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of VACCOIN Transaction Id
 * @details Type of VACCOIN Transaction Id. It is 256-bit hash
 */
