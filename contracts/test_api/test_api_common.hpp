...
#ifdef DISABLE_VACLIB_SERIALIZE
#include <VACiolib/serialize.hpp>
#undef VACLIB_SERIALIZE
#define VACLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  VACLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   VACLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   VACLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   VACLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
