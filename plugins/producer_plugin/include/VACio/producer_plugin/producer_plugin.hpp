...
#include <VACio/http_client_plugin/http_client_plugin.hpp>
...
FC_REFLECT(VACio::producer_plugin::runtime_options, (max_transaction_time)(max_irreversible_block_age)(produce_time_offset_us)(last_block_time_offset_us)(subjective_cpu_leeway_us));
FC_REFLECT(VACio::producer_plugin::greylist_params, (accounts));
