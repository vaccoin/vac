...
CHAINBASE_SET_INDEX_TYPE( VACio::public_key_history_object, VACio::public_key_history_multi_index )

FC_REFLECT( VACio::public_key_history_object, (public_key)(name)(permission) )
