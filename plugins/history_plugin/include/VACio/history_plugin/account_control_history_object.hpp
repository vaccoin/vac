...
CHAINBASE_SET_INDEX_TYPE( VACio::account_control_history_object, VACio::account_control_history_multi_index )

FC_REFLECT( VACio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
