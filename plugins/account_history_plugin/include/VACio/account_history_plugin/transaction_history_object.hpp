...
CHAINBASE_SET_INDEX_TYPE( VACio::transaction_history_object, VACio::transaction_history_multi_index )

FC_REFLECT( VACio::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
