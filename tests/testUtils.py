...
class Utils:
    ...
    VACClientPath="programs/clVAC/clVAC"

    VACWalletName="kVACd"
    VACWalletPath="programs/kVACd/"+ VACWalletName

    VACServerName="nodVAC"
    VACServerPath="programs/nodVAC/"+ VACServerName

    VACLauncherPath="programs/VACio-launcher/VACio-launcher"
    MongoPath="mongo"
