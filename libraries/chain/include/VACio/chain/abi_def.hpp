...
FC_REFLECT( VACio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( VACio::chain::field_def                        , (name)(type) )
FC_REFLECT( VACio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( VACio::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( VACio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( VACio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( VACio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( VACio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
