...
CHAINBASE_SET_INDEX_TYPE(VACio::chain::producer_object, VACio::chain::producer_multi_index)

FC_REFLECT(VACio::chain::producer_object::id_type, (_id))
FC_REFLECT(VACio::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))
