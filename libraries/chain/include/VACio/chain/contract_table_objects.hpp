...
#include <VACio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(VACio::chain::table_id_object, VACio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::key_value_object, VACio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(VACio::chain::index64_object, VACio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::index128_object, VACio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::index256_object, VACio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::index_double_object, VACio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::index_long_double_object, VACio::chain::index_long_double_index)

FC_REFLECT(VACio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(VACio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
