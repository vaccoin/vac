...
#include <VACio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(VACio::chain::global_property_object, VACio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::dynamic_global_property_object,
                         VACio::chain::dynamic_global_property_multi_index)

FC_REFLECT(VACio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(VACio::chain::global_property_object,
