...
CHAINBASE_SET_INDEX_TYPE(VACio::chain::permission_object, VACio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::permission_usage_object, VACio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<VACio::chain::permission_object>, (_id))
FC_REFLECT(VACio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<VACio::chain::permission_usage_object>, (_id))
FC_REFLECT(VACio::chain::permission_usage_object, (id)(last_used))
