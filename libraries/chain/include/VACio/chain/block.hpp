#pragma once
#include <VACio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( VACio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(VACio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(VACio::chain::transaction_receipt, (VACio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(VACio::chain::signed_block, (VACio::chain::signed_block_header), (transactions)(block_extensions) )
