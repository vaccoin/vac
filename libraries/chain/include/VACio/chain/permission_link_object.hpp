...
CHAINBASE_SET_INDEX_TYPE(VACio::chain::permission_link_object, VACio::chain::permission_link_index)

FC_REFLECT(VACio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
