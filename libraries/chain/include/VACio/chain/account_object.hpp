...
#include <VACio/chain/block_timestamp.hpp>
...
namespace VACio { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const VACio::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      VACio::chain::abi_def get_abi()const {
         VACio::chain::abi_def a;
         VAC_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(VACio::chain::account_object, VACio::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(VACio::chain::account_sequence_object, VACio::chain::account_sequence_index)


FC_REFLECT(VACio::chain::account_object, (name)(vm_type)(vm_version)(code_version)(code)(creation_date))
