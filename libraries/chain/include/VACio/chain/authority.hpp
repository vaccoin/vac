...
FC_REFLECT(VACio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(VACio::chain::key_weight, (key)(weight) )
FC_REFLECT(VACio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(VACio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(VACio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
